...
class ExpatImport implements ToCollection, WithCalculatedFormulas, WithStartRow
{
    use Importable;
        ...
        foreach ($rows as $row) {
            ...
            if ($title) {
                ...
                $employee = Employee::create([
                    ...
                    'date_to_job_group' => $this->getTime(data_get($row, $this->headers['date_to_job_group'])),
